    ...
    <div className="rsp-fade-up">
      ...
      <section style={{ padding: '96px 32px', background: '#F9F9F9' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 48 }}>
          ...
          <aside style={{ display: 'flex', flexDirection: 'column', gap: 24, position: 'sticky', top: 92, alignSelf: 'flex-start' }}>
      ...
      <section style={{ background: '#F5C344', padding: '72px 32px', position: 'relative', overflow: 'hidden' }}>
      ...
      <section style={{ background: '#1A1A1A', color: '#FFFFFF', padding: '96px 32px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <section style={{ background: '#F5C344', padding: '88px 32px', position: 'relative', overflow: 'hidden' }}>
      ...
      <section style={{ background: '#2A2A2A', color: '#FFFFFF', padding: '96px 32px' }}>
